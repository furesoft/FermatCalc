...
namespace NiL.JS.Core
{
    ...
    public static class Parser
    {
        ...
        public static CodeNode Parse(ParseInfo state, ref int index, CodeFragmentType ruleSet)
        {
            return Parse(state, ref index, ruleSet, true);
        }

        public static CodeNode Parse(ParseInfo state, ref int index, CodeFragmentType ruleSet, bool throwError)
        {
